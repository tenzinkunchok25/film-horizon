...
export function sidebar() {
    ...
    sidebarInner.innerHTML = `
        ...
        <p class="copyright" style="font-size: 15px">Copyright &copy; 2023</p>
        <a href="https://github.com/tenzinkunchok25" style="font-size:15px" class="sidebar-link">Tenzin Kunchok</a>
        <br/>
        <img
